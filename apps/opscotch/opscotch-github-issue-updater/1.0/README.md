...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-issue-updater-1.0
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-issue-updater:1.0 AS opscotch-github-issue-updater
