...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-issue-updater-1.0.1
- Docker Image: https://github.com/orgs/opscotch/packages/container/package/opscotch-github-issue-updater

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-issue-updater:1.0.1 AS opscotch-github-issue-updater
