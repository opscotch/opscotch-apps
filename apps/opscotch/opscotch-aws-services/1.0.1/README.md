...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-aws-services-1.0.1
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-aws-services:1.0.1 AS opscotch-aws-services
