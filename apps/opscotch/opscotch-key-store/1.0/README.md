...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-key-store-1.0
- Docker Image: `ghcr.io/opscotch/opscotch-key-store:1.0`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-key-store/1.0/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-key-store:1.0 AS opscotch-key-store
FROM ghcr.io/opscotch/opscotch-agent:latest

COPY --from=opscotch-key-store /apps/opscotch-key-store.oapp /apps/opscotch-key-store
