...
## 1.8
- Do not touch host class Double when emitting Actions metrics

## 1.7
- Send Actions error metrics with the timestamp sendMetric overload so a metric emit cannot stop the processor

## 1.6
- Emit GitHub Actions error metrics

## 1.5
- Emit GitHub Actions activity metrics via community `3.1.8`
...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-action-runner-1.9
- Docker Image: `ghcr.io/opscotch/opscotch-github-action-runner:1.9`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-github-action-runner/1.9/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-action-runner:1.9 AS opscotch-github-action-runner
