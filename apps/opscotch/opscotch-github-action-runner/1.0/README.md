...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-action-runner-1.0
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-action-runner:1.0 AS opscotch-github-action-runner
