...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-packager-1.2.2
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-packager:1.2.2 AS opscotch-packager
