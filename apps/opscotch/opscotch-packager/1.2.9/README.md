...
# 1.2.9
- updates packager to use schemas
...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-packager-1.2.9
- Docker Image: `ghcr.io/opscotch/opscotch-packager:1.2.9`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-packager/1.2.9/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-packager:1.2.9 AS opscotch-packager
...
| `opscotch-packager-schema-3.1.8` | `E1D84B260E7454649D315C2D0B6C9C98E9E1514CDE06F887EEB55F4BE29BC5A1` |
