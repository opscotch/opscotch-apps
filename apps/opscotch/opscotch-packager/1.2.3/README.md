...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-packager-1.2.3
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-packager:1.2.3 AS opscotch-packager
