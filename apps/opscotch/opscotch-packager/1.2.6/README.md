...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-packager-1.2.6
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-packager:1.2.6 AS opscotch-packager
