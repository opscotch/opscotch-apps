...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-pr-watcher-1.7
- Docker Image: `ghcr.io/opscotch/opscotch-github-pr-watcher:1.7`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-github-pr-watcher/1.7/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-pr-watcher:1.7 AS opscotch-github-pr-watcher
