...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-pr-watcher-1.0.1
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-pr-watcher:1.0.1 AS opscotch-github-pr-watcher
