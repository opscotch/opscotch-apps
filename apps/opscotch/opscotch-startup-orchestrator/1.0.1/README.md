...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-startup-orchestrator-1.0.1
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-startup-orchestrator:1.0.1 AS opscotch-startup-orchestrator
