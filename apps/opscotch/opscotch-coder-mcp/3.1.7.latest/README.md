...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-coder-mcp-3.1.7.latest
- Docker Image: `ghcr.io/opscotch/opscotch-coder-mcp:3.1.7.latest`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-coder-mcp/3.1.7.latest/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-coder-mcp:3.1.7.latest AS opscotch-coder-mcp
FROM ghcr.io/opscotch/opscotch-agent:latest

COPY --from=opscotch-coder-mcp /apps/opscotch-coder-mcp.oapp /apps/opscotch-coder-mcp
