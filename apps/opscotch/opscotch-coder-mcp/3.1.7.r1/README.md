...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-coder-mcp-3.1.7.r1
- Docker Image: `ghcr.io/opscotch/opscotch-coder-mcp:3.1.7.r1`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-coder-mcp/3.1.7.r1/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-coder-mcp:3.1.7.r1 AS opscotch-coder-mcp
