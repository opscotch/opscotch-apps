...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-coder-mcp-1.14
- Docker Image: `ghcr.io/opscotch/opscotch-coder-mcp:1.14`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-coder-mcp/1.14/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-coder-mcp:1.14 AS opscotch-coder-mcp
