...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-coder-mcp-3.1.8.rc2
- Docker Image: `ghcr.io/opscotch/opscotch-coder-mcp:3.1.8.rc2`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-coder-mcp/3.1.8.rc2/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-coder-mcp:3.1.8.rc2 AS opscotch-coder-mcp
