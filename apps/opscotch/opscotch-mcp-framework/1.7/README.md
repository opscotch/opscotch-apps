...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-mcp-framework-1.7
- Docker Image: `ghcr.io/opscotch/opscotch-mcp-framework:1.7`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-mcp-framework/1.7/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-mcp-framework:1.7 AS opscotch-mcp-framework
