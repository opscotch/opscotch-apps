...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-mcp-framework-3.1.7.latest
- Docker Image: `ghcr.io/opscotch/opscotch-mcp-framework:3.1.7.latest`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-mcp-framework/3.1.7.latest/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-mcp-framework:3.1.7.latest AS opscotch-mcp-framework
