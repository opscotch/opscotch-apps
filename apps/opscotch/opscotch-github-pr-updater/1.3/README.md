...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-pr-updater-1.3
- Docker Image: `ghcr.io/opscotch/opscotch-github-pr-updater:1.3`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-github-pr-updater/1.3/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-pr-updater:1.3 AS opscotch-github-pr-updater
