...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-github-pr-updater-1.1
- Docker Image: `ghcr.io/opscotch/opscotch-github-pr-updater:1.1`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-github-pr-updater/1.1/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-github-pr-updater:1.1 AS opscotch-github-pr-updater
