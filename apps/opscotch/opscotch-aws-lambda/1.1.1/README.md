...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-aws-lambda-1.1.1
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-aws-lambda:1.1.1 AS opscotch-aws-lambda
