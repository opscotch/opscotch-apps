...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-aws-apigw2-http-bridge-1.1.1
...
```Dockerfile
FROM ghcr.io/opscotch/opscotch-aws-apigw2-http-bridge:1.1.1 AS opscotch-aws-apigw2-http-bridge
