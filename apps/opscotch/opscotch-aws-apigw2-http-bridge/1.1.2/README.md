...
- Release: https://github.com/opscotch/opscotch-apps/releases/tag/opscotch-aws-apigw2-http-bridge-1.1.2
- Docker Image: `ghcr.io/opscotch/opscotch-aws-apigw2-http-bridge:1.1.2`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-aws-apigw2-http-bridge/1.1.2/README.md

To use this as a docker image, here is an example Dockerfile:

```Dockerfile
FROM ghcr.io/opscotch/opscotch-aws-apigw2-http-bridge:1.1.2 AS opscotch-aws-apigw2-http-bridge
...
| `opscotch-aws-apigw2-http-bridge-app` | `3E385095D6B8D891A2D9238624B658F4A4E1ECE4AB03620DEBDAB6F0075E0645` |
| `opscotch-aws-apigw2-http-bridge-1.x` | `8FC090A70B90CDCB1586C5FBDCA16641A778C3E807AC9208F5BFAEF70EF6B0B5` |
