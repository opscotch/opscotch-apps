...
- Docker Image: `ghcr.io/opscotch/opscotch-local-development-mcp:3.1.7.latest`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-local-development-mcp/3.1.7.latest/README.md