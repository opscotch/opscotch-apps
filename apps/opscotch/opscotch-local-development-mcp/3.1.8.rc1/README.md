...
- Docker Image: `ghcr.io/opscotch/opscotch-local-development-mcp:3.1.8.rc1`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-local-development-mcp/3.1.8.rc1/README.md