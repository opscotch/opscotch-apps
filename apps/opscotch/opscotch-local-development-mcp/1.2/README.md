...
docker run --rm -p 8080:8080 \
  ...
  -e OPSCOTCH_LOCAL_MCP_ROOTS_JSON='{"workspace":"/workspace","license":"/license","artifacts":"/artifacts"}' \
  -v /home/jeremy/dev/opscotch/community/opscotch-community:/workspace:ro \
...
docker run --rm -p 8080:8080 \
  -e OPSCOTCH_LEGAL_ACCEPTED \
  -e OPSCOTCH_LOCAL_MCP_ROOTS_JSON='{"workspace":"/workspace","app":"/workspace-app","license":"/license"}' \
  -v /home/jeremy/dev/opscotch/community/opscotch-community:/workspace:ro \
