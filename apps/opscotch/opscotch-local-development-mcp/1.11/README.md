...
- Docker Image: `ghcr.io/opscotch/opscotch-local-development-mcp:1.11`
- Catalog: https://github.com/opscotch/opscotch-apps/blob/main/apps/opscotch/opscotch-local-development-mcp/1.11/README.md